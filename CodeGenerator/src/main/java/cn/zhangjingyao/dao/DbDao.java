...
public interface DbDao {
     ...
     * @return
     */
    @Select("select column_name,data_type,is_nullable,column_key,column_comment,column_type from information_schema.columns where table_schema = #{dataBaseName} and table_name = #{tableName}")
